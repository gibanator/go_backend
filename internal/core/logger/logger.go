...
func NewLogger(cfg Config) (*Logger, error) {
	...
	if err := os.MkdirAll(cfg.Folder, 0755); err != nil {
		return nil, fmt.Errorf("could not make log folder")
	}
	...
	if err != nil {
		return nil, fmt.Errorf("open log file fail: %w", err)
	}

	zapConfig := zap.NewDevelopmentEncoderConfig()
	zapConfig.EncodeTime = zapcore.TimeEncoderOfLayout("2006-01-02T15:04:05.999999")
